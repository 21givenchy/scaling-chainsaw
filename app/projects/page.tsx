...
const projects = [
  {
    ...
    subtitle: "Enterprise Challenge",
    description: "Enterprise-level challenge for NTT Data implementing scalable business solutions.",
    tags: ["TypeScript", "Next.js", "Enterprise"],
    color: "from-blue-600 to-indigo-600",
    link: "#",
    stats: "Enterprise Solution",
    year: "2026",
  },
  {
    title: "baggage-loading-idea",
    subtitle: "Logistics Optimization",
    description: "Innovative approach to optimizing baggage loading processes for efficiency and speed.",
    tags: ["Logistics", "Optimization", "Strategy"],
    color: "from-yellow-500 to-orange-600",
    link: "#",
    stats: "Process Design",
    year: "2026",
  },
  {
    title: "tiny-gpu",
    subtitle: "Minimal GPU Architecture",
    description: "Implementation of a minimal GPU architecture exploring hardware-level parallel processing.",
    tags: ["SystemVerilog", "Rust", "Hardware"],
...
const experiments = [
  { name: "speech-to-sign", desc: "Real-time speech translation to sign language", lang: "Python/TensorFlow" },
  { name: "omi-linux", desc: "Linux integration for Omi hardware", lang: "C/Rust" },
  { name: "babyllm", desc: "Small-scale LLM implementations", lang: "Python" },
  { name: "vibe-trading-agents", desc: "AI agents for sentiment-based trading", lang: "Rust" },
  { name: "greta-mobile", desc: "Mobile companion for Greta productivity", lang: "React Native" },
  { name: "HaDes-V", desc: "32-bit pipelined RISC-V processor", lang: "SystemVerilog" },
]
